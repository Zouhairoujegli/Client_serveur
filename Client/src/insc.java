 ...
 * @author gogo
 */
public class insc extends javax.swing.JFrame {
    public Log ho;

    /**
     * Creates new form insc
     */
    public insc() {
        initComponents();
    }
...
///////////////////////////
    ho=(Log) Naming.lookup("//127.0.0.1:1099/logserver");
    
 if(id.equals("") || pass.equals("") || util.equals("") ){
     
     JOptionPane.showMessageDialog(null, "Remplir tous les champs svp\n solde initiale doit etre supérieur à 10" );}
 
else{
      boolean op = ho.utilisateur(ID,  pass, util);
if (op){ JOptionPane.showMessageDialog(null, "Bien ajouté" );}
else{JOptionPane.showMessageDialog(null, "non ajouté" );}
}
}
 }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(insc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
